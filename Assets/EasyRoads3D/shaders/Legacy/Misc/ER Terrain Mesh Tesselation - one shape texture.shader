Shader "EasyRoads3D/Legacy/Terrain/ER Terrain Mesh Tesselation - one shape texture" {
        Properties {
   ...
   //     [Space(10)]_MainTex ("Red Color Texture", 2D) = "white" {}
	//	_NormalMap ("Normalmap", 2D) = "bump" {}
        ...
        [Space(10)]_greenTex ("Green Color Texture", 2D) = "white" {}
      ...
      //      #pragma surface surf BlinnPhong addshadow fullforwardshadows vertex:disp tessellate:tessFixed nolightmap
       ...
       //     float2 uv_Splat2 : TEXCOORD2; 
        ...
        float4 color : COLOR;
            ...
            sampler2D _greenTex;//_MainTex;
            sampler2D _greenNormalMap;//_NormalMap; 
            fixed4 _Color;
            ...
            half _Glossiness;
 			...
 			void surf (Input IN, inout SurfaceOutputStandard o) {
                half4 c = tex2D (_greenTex, IN.uv_greenTex) * _Color;
       ...
       // 	half4 nSurface = tex2D(_NormalMap, IN.uv_MainTex);
            ...
            half4 albSurface = bc.r * tex2D(_greenTex, IN.uv_greenTex);
            albSurface += bc.g * tex2D(_greenTex, IN.uv_greenTex);

            half4 nSurface = bc.r * tex2D(_greenNormalMap, IN.uv_greenTex);
